            ...
            <div class="cust-pages-container details-page mt-5">
                    ...
                    <div class="col-md-10 offset-md-1">
                        ...
                        <div class="login-sec mt-2 p-0 border-0">                        
                            ...
                            <input type="password" placeholder="Current password" class="form-control mb-3" name="">                    
                    
                            <input type="password" placeholder="New password" class="form-control mb-3" name="">                   
                        
                            <input type="password" placeholder="Confirm password" class="form-control mb-3" name="">                
